...
import { CreditCard, Zap, Shield, Clock, CheckCircle, RefreshCw, Camera, Film, Crown } from "lucide-react";
...
function CheckoutContent() {
  ...
  const price = currentPlan.monthly;
    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400">Pay monthly with crypto via NOWPayments.io</p>
        </div>
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  Pay ${price}/month with Crypto
                </>
              )}
            </button>

            <p className="text-xs text-slate-500 text-center mt-4">
              Powered by NOWPayments.io. Supports BTC, ETH, USDT, USDC, and 150+ cryptocurrencies.
            </p>
