  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">Choose a plan that fits your needs. Pay with crypto.</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {plans.map((plan) => {
          ...
          return (
            <div
              key={plan.id}
              className={`bg-white dark:bg-slate-800 rounded-xl border-2 p-4 relative transition-all hover:shadow-lg ${
            ...
            >
              ...
              {isActive && (
                <div className="absolute top-4 right-4 px-2 py-0.5 bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-300 text-[10px] font-bold rounded-full">
                  Active
                </div>
              )}
              {isPending && (
                <div className="absolute top-4 right-4 px-2 py-0.5 bg-amber-100 dark:bg-amber-900/40 text-amber-700 dark:text-amber-300 text-[10px] font-bold rounded-full flex items-center gap-1">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5">
        <h3 className="text-base font-semibold text-slate-900 dark:text-white mb-3">How It Works</h3>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-slate-600 dark:text-slate-300">
          <div className="flex items-start gap-2">
            <span className="w-6 h-6 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 flex items-center justify-center text-xs font-bold shrink-0">1</span>
            <div>
              <p className="font-medium text-slate-900 dark:text-white">Choose & Pay</p>
              <p className="text-xs text-slate-500 dark:text-slate-400">Select a plan and pay with crypto via NOWPayments</p>
            </div>
          </div>
          <div className="flex items-start gap-2">
            <span className="w-6 h-6 rounded-full bg-amber-100 dark:bg-amber-900/40 text-amber-600 dark:text-amber-400 flex items-center justify-center text-xs font-bold shrink-0">2</span>
            <div>
              <p className="font-medium text-slate-900 dark:text-white">Admin Review</p>
              <p className="text-xs text-slate-500 dark:text-slate-400">An admin reviews and approves your subscription</p>
            </div>
          </div>
          <div className="flex items-start gap-2">
            <span className="w-6 h-6 rounded-full bg-green-100 dark:bg-green-900/40 text-green-600 dark:text-green-400 flex items-center justify-center text-xs font-bold shrink-0">3</span>
            <div>
              <p className="font-medium text-slate-900 dark:text-white">Access Granted</p>
              <p className="text-xs text-slate-500 dark:text-slate-400">Your plan activates and all features unlock</p>
            </div>
          </div>
        </div>
      </div>
